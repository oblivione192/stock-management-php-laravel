...
<template>
    <div class="min-h-screen bg-neutral-950 text-neutral-100">
        ...
        >
            ...
            >
                ...
                >
                    <RouterLink
                        to="/"
                        class="rounded-md px-3 py-2 hover:bg-neutral-800"
                        >Home</RouterLink
                    >
                    <RouterLink
                        to="/dashboard"
                ...
                <button
                    ...
                    class="relative -top-3 mt-6 rounded-md border border-red-600 bg-red-600 px-4 py-3 text-sm text-white hover:bg-red-700"
                >
                    Log Out
                </button>
            </div>
        ...
        <WebSocketListenerComponent v-if="profileStore.isAuthenticated"/>
